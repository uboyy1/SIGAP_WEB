...
// frontend/src/pages/kepalaTeknisi/ProfilKepalaTeknisi.jsx
import { useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { useAuth } from '../../context/AuthContext';

export default function ProfilKepalaTeknisi() {
  ...
  const photoBase64 = user?.foto_base64 || null;
      ...
      <div className="overflow-hidden rounded-xl shadow-lg">
        <div className="bg-gradient-to-r from-primary-600 to-primary-800 rounded-t-xl rounded-b-none overflow-hidden">
          <div className="p-7 flex items-center gap-4">
            ...
            <div>
              <h2 className="text-white font-bold text-xl">Profil Kepala Teknisi</h2>
              <p className="text-white/75 text-sm">Informasi profil kepala teknisi sistem</p>
            </div>
          </div>
        </div>
          ...
          <div className="p-7">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="px-4 py-3 text-sm text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  {user?.nama_lengkap || '-'}
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="px-4 py-3 text-sm text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  {user?.email}
                </div>
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="px-4 py-3 text-sm text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700/50 rounded-lg min-h-[96px]">
            ...
            <div className="flex justify-end pt-6 border-t border-gray-200 dark:border-gray-700 mt-6">
              <button
                onClick={() => navigate('/kepala-teknisi/edit-profil')}
                className="px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white rounded-lg text-sm font-semibold transition-colors shadow-lg shadow-primary-600/25 flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4">
